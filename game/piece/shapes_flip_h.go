...
var (
	...
	shapesFlipHTetrominoes = []shapeRect{
		...
		{width: 3, height: 2, size: 4, data: 23},
		{width: 2, height: 3, size: 4, data: 29},
		{width: 2, height: 3, size: 4, data: 53},
		{width: 2, height: 3, size: 4, data: 23},
		{width: 3, height: 2, size: 4, data: 57},
		{width: 3, height: 2, size: 4, data: 15},
